...
################################################################################
# notas
RUTA1=/home/maxheadroom/Documentos/RAW/series_sin_com
WHILE=0
while [ $CONTROL=0 ] ; do
  ...
  then
    ...
    cd /home/maxheadroom/Documentos/RAW/series_sin_com/;
    ...
    sleep 3s && notify-send -i cs-cat-admin "Aviso" "Se cerrara el Script automaticamente" && notify-send -i gshutdown "Script cerrado" "Kill -9" && kill -9 $PPID
  else
    echo "no"
    sleep 1s
    echo $VERF
